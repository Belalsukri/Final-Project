				            ...
				            <div className="col-lg-12">
				                <ul className="list-inline  ">
				                    <li className=" text-muted link-hover">
				                        <Link  className='link-hover  font-color' to="/">Home</Link>
				                    </li>
				                    <li  className="mt-3 text-muted link-hover">
				                        <Link  className='link-hover  font-color' to="/About">About</Link>
				                    </li>
									<li  className="mt-3 text-muted link-hover">
				                        <Link  className='link-hover  font-color' to="/Services">Service</Link>
				                    </li>
				                    <li  className="mt-3  text-muted link-hover ">
				                        <Link className='link-hover  font-color' to="/Contact">Contact</Link>
				                    </li>
				                </ul>
